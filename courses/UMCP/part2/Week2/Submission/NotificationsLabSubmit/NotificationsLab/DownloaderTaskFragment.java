			...
			mContext.sendOrderedBroadcast(new Intent(
					...
					new BroadcastReceiver() {
						...
						public void onReceive(Context context, Intent intent) {
							...
							PendingIntent notiPending = PendingIntent
								...
								notificationBuilder = new Notification.Builder(mContext).
										setContent(mContentView).setAutoCancel(true).setContentIntent(notiPending).
										setSmallIcon(android.R.drawable.stat_sys_warning);
								Notification notification = notificationBuilder.build();


								// TODO: Send the notification
								mNotiManager.notify(MY_NOTIFICATION_ID, notification);
